...
const ViewCampaignModal = ({ isOpen, onClose, campaign }) => {
    ...
    return (
        <Modal
            ...
            footer={footer}
        >
            <div className="space-y-8 py-2 font-primary text-left">
                {/* Header Stats */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-orange-50/50 border border-orange-100 p-5 rounded-sm shadow-sm">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-[10px] font-black text-orange-600 uppercase tracking-widest">Campaign Reference</span>
                        </div>
                    ...
                    <div className="bg-blue-50/50 border border-blue-100 p-5 rounded-sm shadow-sm">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest">Total Hits</span>
                        </div>
                        <p className="text-xl font-black text-gray-800 tracking-tight">{campaign.leads_generated.toLocaleString()}</p>
                    ...
                    <div className="bg-green-50/50 border border-green-100 p-5 rounded-sm shadow-sm">
                        ...
                        <p className="text-xs font-bold text-green-400 mt-2 uppercase mb-0 tracking-tighter italic">Valid till {new Date(campaign.end_date).toLocaleDateString()}</p>
                    </div>
                </div>
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="flex justify-between items-start border-l-2 border-blue-100 pl-3">
                                <div className="text-left">
                                    ...
                                    <p className="text-sm font-bold text-gray-800 uppercase">{campaign.audience_type} Model</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Daily Cap</p>
                                    <p className="text-sm font-bold text-gray-800">{campaign.daily_lead_limit || 'Unlimited'}</p>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-gray-50 border border-gray-100 rounded-sm shadow-inner shadow-gray-100">
                                ...
                                <p className="text-sm font-bold text-gray-800 tracking-tight">
                                    {campaign.max_lead_balance ? `Active Balance Cap: ${campaign.max_lead_balance}` : 'Global Balance Settings Applied'}
                                </p>
                                <p className="text-xs text-gray-400 italic mt-1 font-medium">
                                    {campaign.revert_time_hours ? `Standard Revert Window: ${campaign.revert_time_hours} Hours` : ''}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="relative pl-6 border-l-2 border-orange-100 space-y-8 py-2">
                                <div className="relative text-left">
                                    ...
                                    <p className="text-sm font-bold text-gray-800">{new Date(campaign.start_date).toLocaleString()}</p>
                                </div>
                                ...
                                <div className="relative text-left">
                                    ...
                                    <p className="text-sm font-bold text-gray-800">{new Date(campaign.end_date).toLocaleString()}</p>
                                </div>
                            </div>
                            ...
                            <div className="p-4 bg-orange-50/50 rounded-sm border border-orange-100 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-xs font-bold text-gray-700">Automation Rule-Set v2.0</p>
                                    </div>
                                </div>
