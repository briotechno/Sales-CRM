            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 px-1 font-semibold p-2">
                ...
                <div className="md:col-span-2">
                    ...
                    <textarea
                        ...
                        className="w-full px-4 py-3 border border-gray-200 rounded-sm focus:border-[#FF7B1D] focus:ring-2 focus:ring-[#FF7B1D] focus:ring-opacity-20 outline-none transition-all text-sm hover:border-gray-300 font-semibold resize-none"
                    ></textarea>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div className="bg-orange-50/50 p-4 rounded-sm border border-orange-100 ring-1 ring-orange-100">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-gray-200 rounded-sm focus:border-[#FF7B1D] focus:ring-2 focus:ring-[#FF7B1D] focus:ring-opacity-20 outline-none transition-all font-black text-xl text-orange-600 bg-white hover:border-gray-300"
                            />
                        </div>
