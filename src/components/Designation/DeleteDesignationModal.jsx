...
import { useDeleteDesignationMutation } from "../../store/api/designationApi";
import { toast } from "react-hot-toast";
import Modal from "../common/Modal";

const DeleteDesignationModal = ({ isOpen, onClose, designationId, designationName, refetchDashboard }) => {
        ...
        >
            <div className="flex flex-col items-center text-center text-black font-primary">
                ...
                <p className="text-gray-600 mb-2 leading-relaxed">
                    ...
                    <span className="font-bold text-gray-800">"{designationName || designationId}"</span>?
                </p>
