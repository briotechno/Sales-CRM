        ...
        >
            <div className="space-y-8 text-black bg-white font-sans">
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="text-[11px] font-bold text-gray-700 uppercase tracking-widest mb-3 flex items-center gap-2">
                            <FileText size={16} className="text-[#FF7B1D]" /> Description
                        </h3>
                        <div className="text-gray-700 leading-relaxed bg-gray-50 p-4 rounded-sm border border-gray-100 max-h-40 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200">
