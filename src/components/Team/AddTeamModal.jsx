                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex gap-4 pt-4 border-t border-gray-100">
                        <button
                            ...
                            className="flex-1 bg-[#FF7B1D] text-white px-8 py-3.5 font-bold shadow-md hover:bg-[#e66a15] transition-all duration-300 disabled:opacity-50  text-xs capitalize tracking-widest rounded-sm"
                        >
                            {isLoading ? "Creating..." : "Create Team"}
                        </button>
                        <button
                            type="button" onClick={onClose}
                            className="px-8 py-3.5 border border-gray-300 font-bold text-gray-600 hover:bg-gray-50 transition-all  text-xs capitalize tracking-widest bg-white rounded-sm"
                        >
                            Cancel
                        </button>
                    </div>
