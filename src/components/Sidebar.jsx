    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: (checkPermission("Manage Attendance") || user?.role === 'Super Admin' || user?.role === 'Admin') ? null : "/hrm/attendance/employee",
          permission: "Attendance",
          children: (checkPermission("Manage Attendance") || user?.role === 'Super Admin' || user?.role === 'Admin') ? [
            {
              name: "My Attendance",
