            ...
            <div className="bg-white border border-gray-200 rounded-sm shadow-sm overflow-hidden mb-6">
                <div className="bg-gradient-to-r from-orange-500 to-orange-600 px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3 text-white">
                        ...
                        <div>
                            <h3 className="text-lg font-bold capitalize tracking-wide">Dialer Integration</h3>
                            <p className="text-sm font-medium opacity-90 capitalize mt-0.5">Configure your primary communication provider</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-6 space-y-4">
                    ...
                    <div className="pt-4 flex justify-end gap-3 font-primary">
                        <button
                            className="px-6 py-3 border border-gray-200 text-gray-500 font-bold rounded-sm hover:bg-gray-50 transition-all text-xs capitalize tracking-wide shadow-sm"
                        ...
                        <button
                            onClick={handleSave}
                            disabled={isSaving}
                            className="px-8 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold rounded-sm hover:shadow-lg transition-all text-xs capitalize tracking-wide flex items-center gap-2 active:scale-95 disabled:opacity-70"
                        >
