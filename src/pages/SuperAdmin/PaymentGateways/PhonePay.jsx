            ...
            <div className="min-h-screen">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1 flex items-center gap-2">
                                    ...
                                    <span className="text-[#FF7B1D] font-medium">PhonePe</span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="p-0 ml-6 space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-gray-50 p-6 rounded-sm space-y-4">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="font-bold text-[#FF7B1D]">42%</span>
                                    </div>
                                    <div className="flex justify-between items-center text-sm">
                    ...
                    <div className="bg-orange-50 border border-orange-100 p-6 rounded-sm flex items-start gap-4">
                        ...
                        <div>
                            <h4 className="text-lg font-bold text-gray-800 mb-1">PhonePe Security</h4>
                            <p className="text-sm text-gray-600 leading-relaxed">
                                Integration uses SHA-256 hashing for request payload verification.
                                Secure callback endpoints ensure payment status reliability.
                            </p>
                            <button className="mt-3 text-sm font-bold text-[#FF7B1D] flex items-center gap-1 hover:underline">
                                <CreditCard size={16} /> Transaction Audit
                            </button>
                        </div>
                    </div>
                </div>
