        ...
        <div className="bg-white border-b sticky top-0 z-30">
          <div className="max-w-8xl mx-auto px-4 py-2">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-gray-900 tracking-tight">All Employees</h1>
                <p className="text-[10px] text-gray-500 mt-0.5 flex items-center gap-1.5">
                  <FiHome className="text-gray-400" size={14} /> HRM / <span className="text-orange-500 font-medium">All Employee</span>
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className="flex items-center gap-1 border border-gray-200 rounded-sm bg-gray-50 p-1">
                  <button
                    onClick={() => { setViewMode("list"); setCurrentPage(1); }}
                    className={`p-1.5 rounded-sm transition ${viewMode === "list" ? "bg-orange-500 text-white shadow-sm" : "text-gray-500 hover:bg-gray-200"}`}
                  >
                    <List size={16} />
                  </button>
                  <button
                    onClick={() => { setViewMode("grid"); setCurrentPage(1); }}
                    className={`p-1.5 rounded-sm transition ${viewMode === "grid" ? "bg-orange-500 text-white shadow-sm" : "text-gray-500 hover:bg-gray-200"}`}
                  >
                    <FiGrid size={16} />
                  </button>
                </div>
